...
TSimbGramatical=(ErrorLexico,TConstEntera,TConstReal,TOpRel,TCadena,TOpArit,TIdentificador,Tid,Tvar,Tvariables,Tnot,TEsSimbGramatical,TllaveD,TllaveI,Tdospuntos,TReal,TListaReal,TPuntoyComa,TIgual,TLeer,TEscribir,TParD,TParI,TSi,TMientras,TAgregar,TEliminar,TReemplazar,TCorchD,TCorchI,TComa,Tor,Tand,Tmas,Tmenos,Tpor,Tdiv,Troot,Telev,Tconst,TCantidad,Telemento,pesos,Vprograma,VidVar,VTipo,VCuerpo,VSent,VU,VL,VT,VCond,VCondiciones,VW,VZ,VSino,VExpArit,VA,VB,VD,VC,VE,VF);  //todos los terminales y varibles        // T hace referencia a los terminales de la gramatica, V se refiere a todas las variables
