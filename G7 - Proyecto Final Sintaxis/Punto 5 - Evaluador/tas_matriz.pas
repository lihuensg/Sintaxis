...
Begin
   ...
   TAS[VSent,TReemplazar]^.elementos[3]:=TIdentificador;
   ...
   new(TAS[VB,Tmenos]);
   TAS[VB,Tmenos]^.elementos[1]:=Tmenos;
   ...
   new(TAS[VD,TllaveI]);
   TAS[VD,TllaveI]^.cant:=0;

   new(TAS[VD,Tconst]);
   TAS[VD,Tconst]^.cant:=0;
   ...
   new(TAS[VF,Tconst]);
   TAS[VF,Tconst]^.elementos[1]:=TConst;
