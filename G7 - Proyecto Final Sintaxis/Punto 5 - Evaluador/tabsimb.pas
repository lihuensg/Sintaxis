...
TSimbGramatical=(ErrorLexico,TOpRel,TCadena,TOpArit,TIdentificador,Tvar,Tnot,TEsSimbGramatical,TllaveD,TllaveI,Tdospuntos,TReal,TListaReal,TPuntoyComa,TIgual,TLeer,TEscribir,TParD,TParI,TSi,TMientras,TAgregar,TEliminar,TReemplazar,TCorchD,TCorchI,TComa,Tor,Tand,TSino,Tmas,Tmenos,Tpor,Tdiv,Troot,Telev,Tconst,TCantidad,Telemento,pesos,Vprograma,VidVar,VTipo,VCuerpo,Vvariables,VSent,VU,VL,VT,VCond,VCondiciones,VW,VZ,VSino,VExpArit,VA,VB,VD,VC,VE,VF);  //todos los terminales y varibles        // T hace referencia a los terminales de la gramatica, V se refiere a todas las variables
